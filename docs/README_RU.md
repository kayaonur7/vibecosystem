...
119 agents. 202 skills. 48 hooks. Ноль ручной работы.
...
Существует 48 хуков, но они не запускаются все одновременно. Намерение определяет, какие хуки срабатывают.
